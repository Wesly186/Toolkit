package com.wesly.manage.config.shiro.session;
...
import static com.wesly.manage.config.shiro.session.RedissonSessionScript.*;
...
public class RedissonSession implements Session {
    ...
    public Date getLastAccessTime() {
        ...
        Date res = null;
        try {
            res = script.eval(this.infoKey, RScript.Mode.READ_ONLY, GET_LAST_SCRIPT,
    ...
    public long getTimeout() throws InvalidSessionException {
        ...
        Long res = null;
        try {
            res = script.eval(this.infoKey, RScript.Mode.READ_ONLY, GET_TIMEOUT_SCRIPT,
                    RScript.ReturnType.MAPVALUE, keys);
        } catch (RedisException e) {
            convertException(e);
        }
